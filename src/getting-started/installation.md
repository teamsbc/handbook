...
2. Unpack the image, `unxz teamsbc-44-lhotse-rpi4.raw.xz`.
...
4. Write the image onto the microSD card, `dd if=teamsbc-44-lhotse-rpi4.raw of=/dev/sde bs=4M conv=fsync status=progress`.
...
- [TeamSBC 44 Lhotse (virt, x86_64)](https://artifacts.teamsbc.net/main/latest/44/x86_64/teamsbc-44-lhotse-virt-x86_64.raw.xz)

##### aarch64

- [TeamSBC 44 Lhotse (virt, aarch64)](https://artifacts.teamsbc.net/main/latest/44/aarch64/teamsbc-44-lhotse-virt-aarch64.raw.xz)
...
- [TeamSBC 44 Lhotse (rpi4, aarch64)](https://artifacts.teamsbc.net/main/latest/44/aarch64/teamsbc-44-lhotse-rpi4-aarch64.raw.xz)
...
- [TeamSBC 44 Lhotse (rpi5, aarch64)](https://artifacts.teamsbc.net/main/latest/44/aarch64/teamsbc-44-lhotse-rpi5-aarch64.raw.xz)
